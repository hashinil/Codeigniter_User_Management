       ...
       success: function(response){
        //alert(response);
         if(response == 1){
           ...
           alert('User Group already assigned.');
         }
                                ...
                                <div class="card-body">
                                        ...
                                        <table class="table table-striped">
                                                ...
                                                <?php foreach ($usergroup_list as $usergroup): ?>
                                                        <tr>
                                                                <td><?php echo $usergroup['ug_id']; ?></td>
                                                                <td><?php echo $usergroup['ug_name']; ?></td>
                                                                <td><?php echo ($usergroup['ug_status']==1)? 'Active':'Inactive'; ?></td>
                                                                <td><span class='buttoncustom delete' data-id='<?= $usergroup['ug_id']; ?>'>Delete</span></td>
                                                        </tr>
                                                <?php endforeach; ?>
                                                </tbody>
                                        </table>
